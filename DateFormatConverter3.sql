...
END
 ...
 RETURN @result;
    ...
    --Test equation
 --select [dbo].[standard_date_convert4]('1/12/2018')


   -- This is the insert to load table
--USE mytable
--INSERT INTO dbo.MemberSort_real (FirstName, LastName, DOB, City, [State],JoinDate)
--SELECT FirstName, LastName, dbo.standard_date_convert3(DOB), City, [State],
--		dbo.standard_date_convert3(JoinDate)
